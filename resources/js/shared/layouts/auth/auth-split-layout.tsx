...
export function AuthSplitLayout({
    ...
    return (
        <div className="flex min-h-screen w-full font-sans text-foreground relative z-0">
            ...
            {/* Right Column: Form */}
            <div className="flex w-full flex-1 flex-col justify-center px-5 py-8 sm:px-12 sm:py-12 lg:px-24 relative z-10">
                <div className="mx-auto flex w-full max-w-md flex-col gap-6">
                    {/* Mobile Logo — centered above the card and aligned with the card's width */}
                    <div className="lg:hidden flex justify-center">
                        <Link href={home()} className="bg-white/30 dark:bg-black/30 backdrop-blur-xl p-3 rounded-2xl border border-white/40 shadow-sm transition-transform hover:scale-105 inline-block">
                            <AppLogo />
                        </Link>
                    </div>

                    <div className="flex flex-col gap-8 glass-panel p-6 sm:p-10 rounded-3xl">
